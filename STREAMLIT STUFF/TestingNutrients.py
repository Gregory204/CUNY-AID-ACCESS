...
# LASTLY CREATE THE FULL DATA SET OF SHELTERS FOR ALL 5 BOROUGHS
# WITH CUNY SCHOOLS OF COURSE!
...
'''
******** TESTING BEFORE GETTING RESULTS **********

# # print(df.head())
# # print(df.shape) # 101914 rows, 52 columns
# # print(df.columns)
# # unique_schools = list(df.columns)
# # print(df[['Borough', 'Location', 'Latitude', 'Longitude', 'City']])
...
# # Hunter College : (40.767856030242825, -73.96451868134449)
# # John Jay College : (40.77078057677287, -73.98922347116479)
# # Macaulay Honors College : (40.7740137528978, -73.98017075549797)
...
#     'lat': [40.712776, 40.730610, 40.748817],
#     'lon': [-74.005974, -73.935242, -73.985428]
# }

# # Creating DataFrame and hash map
# schools_df = pd.DataFrame(school_data)
# school_map = {row['school_name']: (row['lat'], row['lon']) for index, row in schools_df.iterrows()}
# print("School Map:")
# print(school_map)

# # Sample list of locations to match
# # locations = [
# #     {'name': 'Location 1', 'lat': 40.710000, 'lon': -74.000000},
# #     {'name': 'Location 2', 'lat': 40.720000, 'lon': -73.980000},
# #     {'name': 'Location 3', 'lat': 40.715000, 'lon': -74.010000},
# #     {'name': 'Location 4', 'lat': 40.725000, 'lon': -73.950000},
# #     {'name': 'Location 5', 'lat': 40.735000, 'lon': -73.990000},
# #     {'name': 'Location 6', 'lat': 40.745000, 'lon': -73.980000},
# #     {'name': 'Location 7', 'lat': 40.755000, 'lon': -74.000000},
# #     {'name': 'Location 8', 'lat': 40.765000, 'lon': -73.970000},
# #     {'name': 'Location 9', 'lat': 40.775000, 'lon': -73.930000},
# #     {'name': 'Location 10', 'lat': 40.785001, 'lon': -73.920000},
# #     {'name': 'Location 11', 'lat': 40.795000, 'lon': -73.950000},
# #     {'name': 'Location 12', 'lat': 40.805000, 'lon': -73.980000}
# # ]
...
# # Match each location to the closest school
# # for location in locations:
# #     print(location)
# #     closest_school = find_closest_school(location, school_map)
# #     print(f"{location['name']} is closest to {closest_school}")
# #     new_dict['School Name'].append(str(closest_school))
# #     # new_dict['lat'].append(location['lat'])
# #     # new_dict['lon'].append(location['lon'])
# #     new_dict['lat_lon'].append(str(location['lat']) + ', ' + str(location['lon']))
...
# # print(df.columns)
# # rat_locations_df = df[['Borough', 'Latitude', 'Longitude', 'Location']]
# # rat_locations_df_manhattan = df.groupby('Borough')


# # print(filtered_df.head())

# # for lat_lon in filtered_df['Location'][0:5]:
# #     closest_school = find_closest_school(lat_lon, filtered_df)


TESTING EX: 
Distances from Location 11:
Distance to School A: 10.29 km
Distance to School B: 7.27 km
Distance to School C: 5.94 km
Location 11 is closest to School C
LOCATION == {'name': 'Location 11', 'lat': 40.795, 'lon': -73.95}
'''